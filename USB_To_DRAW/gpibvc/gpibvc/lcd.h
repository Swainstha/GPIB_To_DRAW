...
#define LCD_EN_PIN 5//2,5,1
	
#define	LCD_RS_PORT PORTA		//R/S line
#define	LCD_RS_PIN	6//3,6,0

#define LCD_D7_PORT PORTA
#define LCD_D7_PIN	1//7,1,5
#define LCD_D6_PORT PORTA
#define LCD_D6_PIN	2 //6,2,4
#define LCD_D5_PORT PORTA
#define LCD_D5_PIN	3  //5,3,3
#define LCD_D4_PORT PORTA
#define LCD_D4_PIN	4  //4,4,2
